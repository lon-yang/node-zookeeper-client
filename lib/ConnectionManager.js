...
ConnectionManager.prototype.connect = function () {
    ...
    self.findNextServer(function (server) {
        ...
        self.socket.on('connect', self.onSocketConnected.bind(self, server));
...
ConnectionManager.prototype.onSocketClosed = function (hasError) {
    self.currentConnectedServer = server;
    var retry = false,
        errorCode,
        pendingPacket;
...
ConnectionManager.prototype.onSocketConnected = function (server) {
    self.currentConnectedServer = server;
    var connectRequest,
        authRequest,
        setWatchesRequest,
